...
quotes[8, 1] = "Yalnızsın, eğer kendin için orada değilsen. -Phil McGraw"
quotes[8, 2] = "Uçmayı seviyorsan, düşmeyi de bileceksin. Korkarak yaşıyorsan, yalnızca hayatı seyredersin..."
quotes[8, 3] = "Nereye gittiğini bilmiyorsan, hangi yoldan gittiğinin hiçbir önemi yoktur."
quotes[8, 4] = "Ömrün ilk yarısı; ikinci yarısını beklemekle, ikinci yarısı da ilk yarısının hasretiyle geçer."
quotes[8, 5] = "Sende, ben, imkansızlığı seviyorum; fakat asla ümitsizliği değil. -Nazım Hikmet"
quotes[8, 6] = "Eğer bir insan sürekli seni üzüyorsa anla ki mutlu etmek istediği kişi sen değilsin."
quotes[8, 7] = "Yalnızsın, eğer kendin için orada değilsen. -Phil McGraw"
quotes[8, 8] = "Düşmanın en büyük hilesi, dostluğudur. -Sadi Şirazi"
quotes[8, 9] = "İyiyi ara, doğruyu ara, güzeli ara fakat kusuru arama."
quotes[8, 10] = "Asla vazgeçmeyin, kaybedenler yalnızca vazgeçenlerdir."
quotes[8, 11] = "Uçmak için kuş olmak gerekmiyor küçük sevinçler olsun yeter. -Cemal Süreya"
quotes[8, 12] = "Sütten çıkınca bütün kaşıklar aktır. Önemli olan içinden çıktığın sütü ak bırakmaktır. -Hz. Mevlana"
quotes[8, 13] = "Edep aklın tercümanıdır. Herkes edebi kadar akıllı, aklı kadar şerefli, şerefi kadar değerlidir."
quotes[8, 14] = "Her elini sıkanla dost, her canını sıkanla düşman olma."
quotes[8, 15] = "Hayat bazı şeyleri kafana vura vura. Bazı şeyleri de kalbini kıra kıra öğretir..."
quotes[8, 16] = "Hırs başarısızlığın son sığınağıdır."
quotes[8, 17] = "Her seven isimsiz bir kahramandır ve insan, sevebildiği kadar insandır!"
quotes[8, 18] = "İyiler asla kaybetmez, kaybedilir. -Peyami Safa"
quotes[8, 19] = "Kırılmış biri çok güzel susar. Her şeyine hasret kalırsın!"
quotes[8, 20] = "Yaşın değil yaşadıkların öğretir sana hayatı."
quotes[8, 21] = "İnsanı farklı yapan affettikleri, güçlü yapan sabrettikleri, kendisi yapan ise vazgeçtikleridir."
quotes[8, 22] = ""
